          ...
          <div className="flex md:flex-row flex-col justify-between items-center gap-x-6">
            <div className="md:w-2/3 ">
              ...
              <p className="text-2xl tracking-wider md:pt-0 pt-3">
                ...
                passion for creating elegant and efficient web solutions. With a
                foundational understanding of computer science and a knack for
                problem-solving, I entered the field of web development driven
                by a desire to make a meaningful impact.
              </p>
            </div>
