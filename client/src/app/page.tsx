  ...
  return (
    ...
    >
      ...
      <div className={`w-5/12 relative flex items-center justify-center`}>
        ...
        <div
          className={`absolute w-[100px] -bottom-10 left-20  border-black border shadow-md shadow-violet-600  h-[100px] bg-violet-700 rounded-full flex items-center justify-center`}
        >
          <p className={`text-5xl`}>💻</p>
        </div>
        <div
          className={`rounded-full overflow-hidden bg-blue-500 border w-[400px] h-[400px] border-black shadow-lg shadow-blue-500`}
        >
          <CustomImage
            alt={`banner`}
            image={`/banner.jpg`}
